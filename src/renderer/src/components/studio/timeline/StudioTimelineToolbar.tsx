...
export default function StudioTimelineToolbar({
  ...
  const actionButtonClass =
    "inline-flex cursor-pointer items-center gap-1 rounded-lg border border-white/10 bg-white/5 px-2 py-1 text-xs text-foreground hover:border-primary/40 disabled:cursor-not-allowed disabled:opacity-50";

  return (
    <header className="relative grid shrink-0 grid-cols-[auto_1fr_auto] items-center gap-2 border-b border-white/10 px-2 py-1.5 sm:px-3">
      <div className="col-start-1 row-start-1 flex items-center gap-2">
        ...
        <div className="flex items-center gap-1 ">
          ...
          <button
            ...
            className="inline-flex cursor-pointer items-center gap-1 rounded-lg border border-white/10 bg-white/5 px-2 py-1 text-xs text-red-400 hover:border-red-400/40 hover:bg-red-500/10 disabled:cursor-not-allowed disabled:opacity-50"
      ...
      <div className="absolute left-1/2 top-1/2 z-10 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center gap-1 sm:gap-2">
        <button
          type="button"
